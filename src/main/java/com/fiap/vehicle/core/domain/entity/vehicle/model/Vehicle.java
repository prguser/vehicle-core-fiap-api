package com.fiap.vehicle.core.domain.entity.vehicle.model;
...
public class Vehicle {
	...
	public Vehicle(String make, String model, String color, Integer mileage, BigDecimal price, String status,
			OffsetDateTime dataFabricacao, OffsetDateTime createdAt) {
		this.make = make;
		this.model = model;
		this.color = color;
